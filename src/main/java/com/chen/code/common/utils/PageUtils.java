...
public class PageUtils<T> {
	 ...
	 * @param count 数据条数
	 */
	public PageUtils(int pageNo, int pageSize, long count) {
	 ...
	 * @param list 本页数据对象列表
	 */
	public PageUtils(int pageNo, int pageSize, long count, List<T> list) {
		this.setCount(count);
...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
	...
	public static void main(String[] args) {
		PageUtils<String> p = new PageUtils<String>(3, 3);
...
//	 */
//	public void setSpringPage(org.springframework.data.domain.PageUtils<T> page){
