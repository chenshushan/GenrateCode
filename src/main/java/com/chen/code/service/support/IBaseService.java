package com.chen.code.service.support;
...
public interface IBaseService<T, ID extends Serializable> {
	...
	List excuteHql(String hql, Object... values);

    List excuteSql(String sql, Object... values);

    List<Map> getMapBySql(String sql, Object... values);
