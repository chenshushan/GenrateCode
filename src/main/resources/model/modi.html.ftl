            ...
            <div class="ibox float-e-margins">
                ...
                <div class="panel-body">
                    <form id="${classname}InfoForm" class="form-horizontal">
                        <input type="hidden" name="${classname}Id" id="${classname}Id" value="${'$'}{entity.${classname}Id}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 text-center">
                                <button id="btn_query" onclick="${classname}Info.editSubmit()" class="btn btn-primary">提交
                                </button>&nbsp;
...
<script>
    <#list columns as column>
        ...
        $("#${column.attrname}").val(${'$'}{entity.${column.attrname}.index});
        </#if>
    </#list>
</script>
</body>
