...
(function () {
    var BSTable = function (bstableId, url, columns) {
        ...
        this.loadSuccess = function (e,data) {

        };

        this.dbclickRow = function (e,data) {

        };

        this.checkRow = function (e,data) {

        };

        this.unCheckRow = function (e,data) {

        };

        this.checkAllRow = function (e,data) {

        };

        this.unCheckAllRow = function (e,data) {

        };

        this.onEditableSave = function (field, row, oldValue, $el) {
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance.on('load-success.bs.table', this.loadSuccess)
                .on('check-all.bs.table', this.checkAllRow())
                .on('uncheck-all.bs.table', this.unCheckAllRow())
                .on('dbl-click-row.bs.table', this.dbclickRow())
                .on('check.bs.table', this.checkRow())
                .on('uncheck.bs.table', this.unCheckRow());
