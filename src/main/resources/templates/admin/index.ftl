    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                               <a class="J_menuItem" href="/gen/list">系统表</a>
                               <a class="J_menuItem" href="/gen/test">test</a>
                               <a class="J_menuItem" href="/gen/table">table</a>
                               <a class="J_menuItem" href="/gen/entitys">实体表列表</a>
                               <a class="J_menuItem" href="/template/list">模板列表</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                <i class="fa fa-user"></i> <span class="label label-primary"></span>【nickName】
                            </a>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="/admin/welcome" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
