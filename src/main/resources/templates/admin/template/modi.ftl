            ...
            <div class="ibox float-e-margins">
                ...
                <div class="panel-body">
                    <form id="templateInfoForm" class="form-horizontal">
                        <input type="hidden" name="templateId" id="templateId" value="${entity.templateId}">
                        <div class="form-group">
                                <div class="condition-div col-sm-6">
                                    <label class="control-label col-sm-4" for="templatePath">模板路径:</label>
                                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 text-center">
                                <button id="btn_query" onclick="templateInfo.editSubmit()" class="btn btn-primary">提交
                                </button>&nbsp;
